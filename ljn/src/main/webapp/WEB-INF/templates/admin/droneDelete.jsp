    ...
    if(pw == pw2) {                 
      $.ajax({
         ...
         success: function(data) {
            if(data == "ok") {
               alert("삭제가 완료되었습니다.")
               opener.parent.location="http://localhost:8800/ljn/droneList.do";
               self.close();
            }
         }
      });
						...
						<div class="container px-4 px-lg-5">
							<div class="row gx-4 gx-lg-5 justify-content-center">
								<div class="col-lg-8 col-xl-6 text-center">
									<h2 class="mt-0" style="color:white">드론삭제</h2>
									<hr class="divider" />
								</div>
							</div>
							<div class="row gx-4 gx-lg-5 justify-content-center mb-5">
								<div class="col-lg-6">
									<form id="contactForm" data-sb-form-api-token="API_TOKEN">
										...
										<input type="hidden" class="size" id="droneNo" name="droneNo" value="${SessiondroneNo}" />
										...
										<div style="text-align: right">																					
											<input type="button" style="width:80px; height:40px;" onclick="droneDelete()" class="btn btn-primary btn-sm" value="삭제" />
										</div>
									</form>
								</div>
							</div>

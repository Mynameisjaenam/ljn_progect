	...
	<header class="masthead">
		<div id="con">
			<div id="rental">
				<div id="rental_form">
					<form>
						<h3 class="login" style="letter-spacing: -1px; color:white;">문의글 조회</h3>
						...
						<div align="right" >						
						<!-- <input type="button" style="width:100px; height:50px; background-color: #CC9966;" class="btn btn-primary btn-sm" onclick="location.href='adminAnswer.do'" value="답글남기기" />	 -->
						<input type="button" style="width:80px; height:40px; background-color: #CC9966;" class="btn btn-primary btn-sm" onclick="adminAnswer(${selectQuestion.questionNo})" value="답글남기기" />										
						</div>
						<p></p>
						<br> <input type="button" style="width:100px; height:50px; background-color: #CC9966;" class="btn btn-primary btn-sm" onclick="location.href='adminQuestionList.do'" value="목록으로" />
					</form>
				</div>
			</div>
		</div>

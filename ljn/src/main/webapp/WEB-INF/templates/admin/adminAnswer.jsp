	...
	<header class="masthead">
		<div id="con">
			<div id="rental">
				<div id="rental_form">
					<form>
						<h3 class="login" style="letter-spacing: -1px; color:white;">문의답글 작성</h3>						
        				<input id="questionNo" name="questionNo" value="${SessionquestionNo}" type="hidden" />
						<br>
						<hr>
						<br>
						<div id="mainHide">
						...
						<div align="right" >
							<input type="button" style="width:100px; height:50px; background-color: #CC9966;" class="btn btn-primary btn-sm" onclick="insertAnswer()" value="답글달기" />
							
						</div>							
						<p></p>
						<br> <input type="button" style="width:100px; height:50px; background-color: #CC9966;" class="btn btn-primary btn-sm" onclick="location.href='main.do'" value="홈으로" />
					</form>
				</div>
			</div>
		</div>

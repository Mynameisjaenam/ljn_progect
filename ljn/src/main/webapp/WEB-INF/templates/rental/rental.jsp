							...
							<div class="row gx-4 gx-lg-5 justify-content-center mb-5">
								<div class="col-lg-6">
									<form id="contactForm" data-sb-form-api-token="API_TOKEN">
										...
										<div class="form-floating mb-3">
										<input type="text" class="form-control" id="droneNo" name="droneNo" value="${SessiondroneNo}">
											<!-- <input class="form-control" id="droneNo" name="droneNo" type="text" /> -->
											<select id="droneNo" name="droneNo" class="form-control">
							                   <option value="">선택</option>
							                   <option value="1">1. 농업용 드론</option>
							                   <option value="2">2. 농업용 드론</option>
							                   <option value="3">3. 농업용 드론</option>
							                   <option value="4">4. 촬영용 드론</option>
							                   <option value="5">5. 촬영용 드론</option>

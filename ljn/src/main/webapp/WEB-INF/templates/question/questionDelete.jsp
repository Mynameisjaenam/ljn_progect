    ...
    if(pw == pw2) {                 
      $.ajax({
         ...
         success: function(data) {
            if(data == "ok") {
               alert("취소가 완료되었습니다.")
               opener.parent.location="http://localhost:8800/ljn/selectQuestionList.do";
               self.close();
            }
         }
      });
								...
								<div class="col-lg-6">
									<form id="contactForm" data-sb-form-api-token="API_TOKEN">
										...
										<div style="text-align: right">																					
											<input type="button" style="width:80px; height:40px;" onclick="questionCancel()" class="btn btn-primary btn-sm" value="취소" />
										</div>
									</form>
								</div>
							</div>

    ...
    <body id="page-top">
        ...
        <section class="page-section bg-dark text-white">
            <div class="container px-4 px-lg-5 text-center">
                <h2 class="mb-4">지금 바로 경험해 보세요!</h2>
                <%if(userId != null && userPw != null) {%>
                <input type="button" onclick="location.href='rentalDate.do'" class="btn btn-light btn-xl " value="대여하기" />
                <%} else { %>
                <input type="button" onclick="location.href='login.do'" class="btn btn-light btn-xl" value="대여하기" />
                <%} %>                
            </div>
        </section>

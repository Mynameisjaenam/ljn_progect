	...
	<header class="masthead">
		<div id="con">
			<div id="rental">
				<div id="rental_form">
					<form>
						<h3 class="login" style="letter-spacing: -1px; color:white;">자유게시판</h3>
						<br>
						<hr>
						<br>
						<div id="mainHide">
								...
								<tbody>
									<c:forEach var="list" items="${boardList}">
										<tr style="color:white">
											...
											<td><a href="selectBoard.do?boardNo=${list.boardNo}" >${list.title}</a></td>
											<td>${list.content}</td>
											<td>${list.userId}</td>											
				            ...
				            <nav aria-label="Page navigation" style="text-align: center;">         
				               <ul class="pagination justify-content-center">
				                  ...
				                  <c:if test="${lastPage < totalPage}">
				                     <li><a class="page-link" href="boardList.do?viewPage=${firstPage + pageList}">다음</a></li>
				                  </c:if>
				               </ul>      
				            </nav> 
				         </div>
